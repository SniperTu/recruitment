...
class Candidate(models.Model):
    ...
    hr_responsibility = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR坦诚沟通')
    ...
    class Meta:
        ...
        permissions = [
            ...
            ("notify", "notify interview for candidate review"),
        ]
