# Generated by Django 2.2.13 on 2020-11-27 15:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_interview', models.CharField(blank=True, max_length=256, verbose_name='面试官')),
                ...
                ('second_interview', models.CharField(blank=True, max_length=256, verbose_name='面试官')),
                ('second_remark', models.CharField(blank=True, max_length=135, verbose_name='初试备注')),
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR复试综合等级')),
                ('hr_responsibility', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR坦诚沟通')),
            ...
            options={
                ...
                'db_table': 'candidate',
                'permissions': [('export', 'Can export candidate list'), ('notify', 'notify interview for candidate review')],
            },
        ),
    ]
